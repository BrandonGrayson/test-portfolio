    ...
    return (
        <div className='container hero d-flex flex-row justify-content-center col-sm-12 col-md-12 col-lg-12 col-xl-12' style={styles.hero}>
            <div className='flex-column' style={styles.el}>
              ...
              <Link  to='/about' ><h1 style={styles.font}>Hello.</h1></Link>  
                < Link to='/portfolio' ><h1 className='mt-5' style={styles.link} >I Am</h1></Link>
                <Link to='/contact' ><h1 className='mt-5' style={styles.link}>Brandon</h1></Link>
            </div>
